...
function add() {
    ...
    if (olddb == "" || slave_db == "" || newdb == "" || master_id == "" || slave_id == "") {
        ...
        add_div('[')
        add_div('"' + olddb    + '","' + master_name + '","' + master_id + '",')
        add_div('"' + slave_db + '","' + slave_name  + '","' + slave_id  + '",')
        add_div('"' + newdb    + '",')
        add_div('],')
        ...
        // 新增信息模块
        del_div('main_tmp');
        add_tmp('main_tmp', 'ttt1', '[')
        add_tmp('main_tmp', 'ttt1', '"' + olddb    + '","' + master_name + '","' + master_id + '",')
        add_tmp('main_tmp', 'ttt1', '"' + slave_db + '","' + slave_name  + '","' + slave_id  + '",')
        add_tmp('main_tmp', 'ttt1', '"' + newdb    + '",')
        add_tmp('main_tmp', 'ttt1', '],')
...
function add_info() {
    ...
    if (combine_infos == "" || combine_out == "") {
        ...
        // "4_s287_h1": ["4_s287","4_s288","4_s289"],
